...
export default function useTSWithdrawUSDC() {
  ...
  const {
    ...
    txHash,
    txReceipt,
    isLoading: isLoadingWithdrawUSDCTx,
    fetchTransaction: fetchWithdrawUSDCTx
  } = useTransaction(TokenSaleContract, methodName);

  return {
    /** Tx Fee */
    isCallSuccessWithdrawUSDCTxFee: isCallSuccess,
    isLoadingWithdrawUSDCTxFee: isLoadingTxFee,
    fetchWithdrawUSDCTxFee: fetchTrxFee,
    displayWithdrawUSDCTxFee: display,
    setWithdrawUSDCTxFeeLoading: setLoading,
