...
export default function useTSDepositUSDC() {
  ...
  const {
    ...
    txHash,
    txReceipt,
    isLoading: isLoadingDepositUSDCTx,
    fetchTransaction: fetchDepositUSDCTx
  } = useTransaction(TokenSaleContract, methodName);

  return {
    /** Tx Fee */
    isCallSuccessDepositUSDCTxFee: isCallSuccess,
    isLoadingDepositUSDCTxFee: isLoadingTxFee,
    fetchDepositUSDCTxFee: fetchTrxFee,
    displayDepositUSDCTxFee: display,
    setDepositUSDCTxFeeLoading: setLoading,
