...
export default function useSVAddAllPoolVote() {
  const methodName = "addAllPoolVote";
  ...
  const {
    ...
    fetchTransaction: fetchAddAllPoolVoteTx
  ...
  return {
    /** Tx Fee */
    isCallSuccessAddAllPoolVoteTxFee: isCallSuccess,
    isLoadingAddAllPoolVoteTxFee: isLoadingTxFee,
    fetchAddAllPoolVoteTxFee: fetchTrxFee,
    displayAddAllPoolVoteTxFee: display,
    setAddAllPoolVoteTxFeeLoading: setLoading,

    /** Tx */
    isLoadingAddAllPoolVoteTx: isLoadingTx,
    fetchAddAllPoolVoteTx,

    /** Helpers */
    isValidAddAllPoolVoteTx: isValidTx
  };
}
