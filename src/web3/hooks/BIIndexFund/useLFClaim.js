...
export default function useLFClaim() {
  ...
  const {
    ...
    txHash,
    txReceipt,
    isLoading: isLoadingClaimTx,
    fetchTransaction: fetchClaimTx
  } = useTransaction(LPFarmContract, methodName);

  return {
    /** Tx Fee */
    isCallSuccessClaimTxFee: isCallSuccess,
    isLoadingClaimTxFee: isLoadingTxFee,
    fetchClaimTxFee: fetchTrxFee,
    displayClaimTxFee: display,
    setClaimTxFeeLoading: setLoading,
