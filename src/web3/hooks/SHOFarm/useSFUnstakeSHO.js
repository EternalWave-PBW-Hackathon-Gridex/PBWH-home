...
export default function useSFUnstakeSHO() {
  ...
  return {
    /** Tx Fee */
    isCallSuccessUnstakeSHOTxFee: isCallSuccess,
    isLoadingUnstakeSHOTxFee: isLoadingTxFee,
    fetchUnstakeSHOTxFee: fetchTrxFee,
    displayUnstakeSHOTxFee: display,
    setUnstakeSHOTxFeeLoading: setLoading,

    /** Tx */
    isLoadingUnstakeSHOTx: isLoadingTx,
    fetchUnstakeSHOTx: fetchTransaction,

    /** Helpers */
    isValidUnstakeSHOTx: isValidTx
  };
}
