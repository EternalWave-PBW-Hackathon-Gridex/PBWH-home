...
export default function useSFClaimUnlockedSHOUnlockSHO() {
  const methodName = "claimUnlockedSHO";
  ...
  const {
    ...
    fetchTransaction: fetchClaimUnlockedSHOTx
  ...
  return {
    /** Tx Fee */
    isCallSuccessClaimUnlockedSHOTxFee: isCallSuccess,
    isLoadingClaimUnlockedSHOTxFee: isLoadingTxFee,
    fetchClaimUnlockedSHOTxFee: fetchTrxFee,
    displayClaimUnlockedSHOTxFee: display,
    setClaimUnlockedSHOTxFeeLoading: setLoading,

    /** Tx */
    isLoadingClaimUnlockedSHOTx: isLoadingTx,
    fetchClaimUnlockedSHOTx,

    /** Helpers */
    isValidClaimUnlockedSHOTx: isValidTx
  };
}
