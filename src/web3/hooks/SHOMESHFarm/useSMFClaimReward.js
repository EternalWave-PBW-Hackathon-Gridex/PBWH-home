...
export default function useSMFClaimReward() {
  ...
  const {
    ...
    fetchTransaction: fetchClaimRewardTx
  ...
  return {
    /** Tx Fee */
    isCallSuccessClaimRewardTxFee: isCallSuccess,
    isLoadingClaimRewardTxFee: isLoadingTxFee,
    fetchClaimRewardTxFee: fetchTrxFee,
    displayClaimRewardTxFee: display,
    setClaimRewardTxFeeLoading: setLoading,

    /** Tx */
    isLoadingClaimRewardTx: isLoadingTx,
    fetchClaimRewardTx,

    /** Helpers */
    isValidClaimRewardTx: isValidTx
  };
}
