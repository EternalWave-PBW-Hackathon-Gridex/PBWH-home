...
export default function useXSFUnstakeXSHO() {
  ...
  return {
    /** Tx Fee */
    isCallSuccessUnstakeXSHOTxFee: isCallSuccess,
    isLoadingUnstakeXSHOTxFee: isLoadingTxFee,
    fetchUnstakeXSHOTxFee: fetchTrxFee,
    displayUnstakeXSHOTxFee: display,
    setUnstakeXSHOTxFeeLoading: setLoading,

    /** Tx */
    isLoadingUnstakeXSHOTx: isLoadingTx,
    fetchUnstakeXSHOTx: fetchTransaction,

    /** Helpers */
    isValidUnstakeXSHOTx: isValidTx
  };
}
