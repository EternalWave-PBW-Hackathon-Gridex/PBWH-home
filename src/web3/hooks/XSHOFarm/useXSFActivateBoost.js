...
export default function useXSFActivateBoost() {
  const methodName = "claimAndActivateBoost";
  ...
  return {
    /** Tx Fee */
    isCallSuccessActivateBoostTxFee: isCallSuccess,
    isLoadingActivateBoostTxFee: isLoadingTxFee,
    fetchActivateBoostTxFee: fetchTrxFee,
    displayActivateBoostTxFee: display,
    setActivateBoostTxFeeLoading: setLoading,

    /** Tx */
    isLoadingActivateBoostTx: isLoadingTx,
    fetchActivateBoostTx: fetchTransaction,

    /** Helpers */
    isValidActivateBoostTx: isValidTx
  };
}
